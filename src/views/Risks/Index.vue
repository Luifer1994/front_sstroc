    ...
    <div class="content-wrapper table-responsive">
      <div class="card">
        <div class="card-body">
          ...
          <router-link to="/risks-register" class="btn btn-primary text-right"
            >Registrar riesgo</router-link
          >

          <div v-if="!risks" class="d-flex justify-content-center mt-4">
            <div
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <tr v-for="risk in risks" :key="risk.id">
                    ...
                    <td>
                      <button @click="riskUpdate(risk.id)" class="btn btn-warning btn-sm">
                        <img
...
export default {
  ...
  methods: {
    ...
    riskUpdate(id) {
      this.$router.push({ path: "/risks-update/" + id });
    },
    async getrisks(limit = null, page = null) {
      if (limit) {
        this.limit = limit;
      }
      if (page) {
    ...
    showAlert(id) {
      ...
      this.$swal({
        ...
        text: "Al eliminrisko no podrás volver atras!",
        icon: "warning",
    ...
    //detele risk from database and show success message
    async delete(id) {
      const res = await createInstaceAxios.delete("risk-delete/" + id);
      this.$swal({
        title: "Eliminado!",
