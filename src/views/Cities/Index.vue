    ...
    <div class="content-wrapper table-responsive">
      <div class="card">
        <div class="card-body">
          ...
          <router-link to="/cities-register" class="btn btn-primary text-right"
            >Registrar Ciudad</router-link
          >

          <div v-if="!cities" class="d-flex justify-content-center mt-4">
            <div
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <tr v-for="city in cities" :key="city.id">
                    ...
                    <td>
                      <button @click="cityUpdate(city.id)" class="btn btn-warning btn-sm">
                        <img
...
export default {
  ...
  methods: {
    ...
    async getcities(limit = null, page = null) {
      if (limit) {
        this.limit = limit;
      }
      if (page) {
    ...
    showAlert(id) {
      ...
      this.$swal({
        ...
        text: "Al elimincityo no podrás volver atras!",
        icon: "warning",
    ...
    //detele city from database and show success message
    async delete(id) {
      const res = await createInstaceAxios.delete("city-delete/" + id);
      this.$swal({
        title: "Eliminado!",
