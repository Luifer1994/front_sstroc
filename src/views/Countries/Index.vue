    ...
    <div class="content-wrapper table-responsive">
      <div class="card">
        <div class="card-body">
          ...
          <router-link to="/country-register" class="btn btn-primary text-right"
            >Registrar Pais</router-link
          >

          <div v-if="!countries" class="d-flex justify-content-center mt-4">
            <div
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <tr v-for="country in countries" :key="country.id">
                    ...
                    <td>
                      <button
                        @click="countryUpdate(country.id)"
...
export default {
  ...
  methods: {
    countryUpdate(id) {
      this.$router.push({ path: "/country-update/" + id });
    },
    async getcountries(limit = null, page = null) {
      if (limit) {
        this.limit = limit;
      }
      if (page) {
    ...
    showAlert(id) {
      ...
      this.$swal({
        ...
        text: "Al elimincountryo no podrás volver atras!",
        icon: "warning",
    ...
    //detele country from database and show success message
    async delete(id) {
      const res = await createInstaceAxios.delete("country-delete/" + id);
      this.$swal({
        title: "Eliminado!",
